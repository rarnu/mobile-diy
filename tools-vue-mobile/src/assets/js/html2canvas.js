...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    (function (BACKGROUND_CLIP) {
        ...
        BACKGROUND_CLIP[BACKGROUND_CLIP["TEXT"] = 3] = "TEXT";
    ...
    var createCJKCounter = function (value, numbers, multipliers, negativeSign, suffix, flags) {
        ...
        for (var digit = 0; tmp > 0 && digit <= 4; digit++) {
            ...
            } else if (coefficient === 1 && digit > 0) {b
    ...
    */
    ...
    var CanvasRenderer = /** @class */ (function () {
        function CanvasRenderer(options) {
            ...
            this.ctx.textBaseline = 'ideographic';//doneTest
            this._activeEffects = [];
        ...
        CanvasRenderer.prototype.renderTextNode = function (text, styles, container) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, font, fontFamily, fontSize, _c, lineLength, x0, x1, x, y0, y1, y, canvas, xctx, gradient_1;
                var _this = this;
                var adorWidth = 0;
                    ...
                    text.textBounds.forEach(function (text) {
                        ...
                        if (styles.backgroundClip[0] == 3) {
                            if (styles.backgroundImage[0] === undefined) {
                                _this.ctx.fillStyle = asString(styles.backgroundColor);
                            } else {
                                _c = calculateGradientDirection(styles.backgroundImage[0].angle, adorWidth, adorHeight), lineLength = _c[0], x0 = _c[1], x1 = _c[2], y0 = _c[3], y1 = _c[4];
                                canvas = document.createElement('canvas');
                                canvas.width = adorWidth;
                                canvas.height = adorHeight;
                                xctx = canvas.getContext('2d');
                                gradient_1 = xctx.createLinearGradient(adorLeft + x0, adorTop + y0, adorLeft + x1, adorTop + y1);
                                processColorStops(styles.backgroundImage[0].stops, lineLength).forEach(function (colorStop) {
                                    return gradient_1.addColorStop(colorStop.stop, asString(colorStop.color));
                                });
                                _this.ctx.fillStyle = gradient_1;
                            }
                        } else {
                    ...
                    switch (_b.label) {
                        ...
                        case 14:
                            ...
                            if (isTextInputElement(container) && container.value.length) {
                                ...
                                this.ctx.restore();
                                this.ctx.textBaseline = 'bottom';//donetest
